...
#nb_images_test=40
#nb_images_training_with_gt=20
#nb_images_training_with_gt=200
#nb_images_training_with_gt=30


#nb_images_training_with_gt=15



#nb_images_training_with_gt=5


nb_images_training_with_gt=50
...
def create_lists_one_fold(list_paths_flair_patients, index_images_test, nb_images_training_with_gt,nb_images_training_without_gt,nb_images_test):
...
for num_fold in range(nb_folds):
	...
	list_paths_patients_training_with_gt,list_paths_patients_training_without_gt,list_paths_patients_test=create_lists_one_fold(list_paths_flair_patients, index_images_test, nb_images_training_with_gt,nb_images_training_without_gt,nb_images_test)
	...
	if(os.path.isfile(filename_patients_training_with_gt_this_fold)):
		print("File exists")
		sys.exit(2)
